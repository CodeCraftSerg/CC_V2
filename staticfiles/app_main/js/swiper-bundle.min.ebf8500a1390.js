...
var Swiper = function () {
    ...
    function L(e) {
        return void 0 === e && (e = {}), M || (M = function (e) {
            ...
            const s = P(), a = r(), i = a.navigator.platform, n = t || a.navigator.userAgent,
    ...
    function R(e) {
        ...
        const b = (h - c[f]) / g, y = f < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
        if (m > r.longSwipesMs) {
    ...
    const Q = {
        eventsEmitter: I, update: O, translate: D, transition: {
    ...
    const ue = [function (e) {
        ...
        Object.assign(t.scrollbar, {
            ...
            }, disable: L, updateSize: b, setTranslate: g, init: C, destroy: P
        })
    }, function (e) {
        ...
        let {swiper: t, extendParams: s, on: a} = e;
        s({coverflowEffect: {rotate: 50, stretch: 0, depth: 100, scale: 1, modifier: 1, slideShadows: !0}}), oe({
        ...
        let {swiper: t, extendParams: s, on: a} = e;
        s({cardsEffect: {slideShadows: !0, rotate: !0, perSlideRotate: 2, perSlideOffset: 8}}), oe({
            effect: "cards",
            swiper: t,
            on: a,
            setTranslate: () => {
